...
EVENT_HUB_CONNECTION_STRING=os.getenv("EVENT_HUB_CONNECTION_STRING_NW")
EVENT_HUB_NAME=os.getenv("EVENT_HUB_NAME_LAD")
ARANGO_COLLECTION_NAME=os.getenv("ARANGO_COLLECTION_NAME_NW")
...
def process_batch(df, epoch_id):
    ...
    for row in df.collect():
        ...
        documents = json.loads(row.decoded_field)
        for document in documents:
            ...
            decoded_fields.append(document)
